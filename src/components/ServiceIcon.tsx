...
/**
 * Hizmet ikonları — tek kaynak. Hem ana sayfadaki Services kartları hem de
 * /hizmetler/[slug] detay sayfaları aynı ince (strokeWidth 1.25) sage ikonları
 * `iconKey` ile buradan kullanır. src/lib/services.ts içindeki `iconKey`
