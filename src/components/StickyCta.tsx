  ...
  return (
    ...
    >
      <div className="mx-auto max-w-xl px-4 pt-3">
        <div className="flex items-center justify-between gap-3 rounded-2xl bg-forest px-4 py-3 text-cream shadow-[0_-4px_24px_rgba(20,42,32,0.25)] ring-1 ring-cream/10">
